...
class Goals extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>My Tasks</Text>
          <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Add Task')}}>

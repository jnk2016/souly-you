...
class EditCycle extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>My Recipes</Text>
        </View>
        <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Add Recipe')}}>

...
class AddSymptoms extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>Grocery List</Text>
        </View>
        <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Edit Groceries')}}>
          <Text>Edit Groceries</Text>
        </TouchableOpacity>
      </View>
    </View>
  )}

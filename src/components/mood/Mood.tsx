...
class Mood extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>My Moods</Text>
        </View>
          <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Record Mood')}}>
            <Text style={{marginTop:'20px'}}>Record Mood</Text>
          </TouchableOpacity>

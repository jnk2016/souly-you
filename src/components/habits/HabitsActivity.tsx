...
class HabitsActivity extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>My Activity</Text>
        </View>
          <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Habit')}}>
            <Text>Make Bed</Text>
          </TouchableOpacity>
      </View>
    </View>

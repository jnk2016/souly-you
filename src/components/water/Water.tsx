...
class Water extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>My Water</Text>
        </View>
          <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Record Water')}}>
            <Text style={{marginTop:'20px'}}>Record Water</Text>
          </TouchableOpacity>

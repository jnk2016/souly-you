...
class Budget extends React.Component<Props,any> {
    ...
    <View style= {globalstyles.frame}>
      <View style= {styles.main}>
        <View style= {globalstyles.header}>
          ...
          <Text style= {globalstyles.headerTextCultured}>My Budget</Text>
        </View>
          <TouchableOpacity onPress={()=>{this.props.navigation.navigate('My Savings Goals')}}>
            <Text style={{marginTop:'20px'}}>Savings Goals</Text>
          </TouchableOpacity>
